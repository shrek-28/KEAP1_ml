...
def evaluate_nested_voting(folder_path,
                           outer_splits=5,
                           inner_splits=3,
                           output_csv="voting_results.csv"):
    ...
    n_combinations = len(param_grid["model__weights"])
...
if __name__ == "__main__":
    ...
    evaluate_nested_voting(
        folder_path="data/final_features_data",
        outer_splits=5,
        inner_splits=3,
        output_csv="data/regression_results/voting_results.csv"
    )