...
def evaluate_nested_gbr(folder_path, outer_splits=5, inner_splits=3, output_csv="gbr_nested_results.csv"):
...
if __name__ == "__main__":
    ...
    output_csv = "data/regression_results/gbr_results.csv"

    results = evaluate_nested_gbr(
