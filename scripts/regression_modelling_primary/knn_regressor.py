...
parser = argparse.ArgumentParser(description="Nested cross-validation KNN regression")
...
for file in os.listdir(args.input):
    ...
    for train_idx, test_idx in outer_cv.split(X):
        ...
        grid = GridSearchCV(pipeline, param_grid, cv=inner_cv, scoring="neg_root_mean_squared_error", n_jobs=-1, error_score="raise")
