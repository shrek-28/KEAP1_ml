...
def evaluate_nested_catboost(
        folder_path,
        outer_splits=5,
        inner_splits=3,
        output_csv="catboost_nested_results.csv"
):
    ...
    total_param_combinations = (
        len(param_grid["model__iterations"])
        * len(param_grid["model__depth"])
...
if __name__ == "__main__":
    ...
    output_csv = "data/regression_results/catboost_results.csv"

    results = evaluate_nested_catboost(
