...
OUT_SHAP_VALUES = "data/SHAP/ridge_regressor/ridge_shap_values.csv"
OUT_SHAP_VALUES_INDEXED = "data/SHAP/ridge_regressor/ridge_shap_values_with_index.csv"
OUT_SHAP_IMPORTANCE = "data/SHAP/ridge_regressor/ridge_shap_feature_importance.csv"
...
# Ridge = linear model => LinearExplainer
